      ...
      <AppBar position="static" color="primary" elevation={0}>
        <Toolbar>
          ...
          <Typography variant="body2" color="inherit">
            Already have an account? <Link to="/client-login" style={{ color: '#fff', textDecoration: 'none', fontWeight: 600 }}>Login here</Link>
          </Typography>
        </Toolbar>
      </AppBar>
          ...
          <Card elevation={8} sx={{ borderRadius: 4, overflow: 'hidden' }}>
            <Box sx={{ bgcolor: 'primary.main', p: 3, textAlign: 'center' }}>
              ...
              <Typography variant="body1" color="white" sx={{ opacity: 0.9, mt: 1 }}>
                Join our sustainable community and start recycling today
              </Typography>
            </Box>
            <CardContent sx={{ p: 4 }}>
              {error && (
